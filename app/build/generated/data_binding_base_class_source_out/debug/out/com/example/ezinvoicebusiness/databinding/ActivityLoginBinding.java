...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnLogin,
      @NonNull Button btnResetPassword, @NonNull Button btnSignup, @NonNull EditText email,
      @NonNull ImageView logo, @NonNull EditText password, @NonNull ProgressBar progressBar) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnLogin, btnResetPassword,
          btnSignup, email, logo, password, progressBar);
    }
